...
public class Cst_customer implements Serializable {
	...
	public Cst_customer(String custNo, String custName, String custRegion,
			Integer custManagerId, Integer custLevel, Integer custSatisfy,
			Integer custCredit, String custAddr, String custZip,
			String custTel, String custFax, String custWebsite,
			String custLicenceNo, String custChieftain, Integer custBankroll,
			Integer custTurnover, String custBank, String custBankAccount,
			String custLocalTaxNo, String custNationalTaxNo, String custStatus,
			String crname, String cmname, String clname) {
		super();
		this.custNo = custNo;
