...
<html>
  <head>
    ...
    <title>My JSP 'index-ec.jsp' starting page</title>
...
function initialise() {
	...
	L0101 = theMenu.addChild(L01, "Document", "销售机会管理", "~sale/findsalchance.html", "销售机会管理...");
	L0102 = theMenu.addChild(L01, "Document", "客户开发计划", "~sale/saldev.html", "客户开发计划...");

	
	L02 = theMenu.addChild(l2ID, "Folder", "客户管理", "", "客户管理...");
	L0201 = theMenu.addChild(L02, "Document", "待完善客户信息", "~cust/cust/findcustwait.html", "客户信息管理...");
	L0201 = theMenu.addChild(L02, "Document", "客户信息管理", "~cust/cust/findcustomer.html", "客户信息管理...");
	L0201 = theMenu.addChild(L02, "Document", "客户流失管理", "~cust/lost/findcstlost.html", "客户流失管理...");	

	L03 = theMenu.addChild(l2ID, "Folder", "服务管理", "", "客户服务管理...");
	L0301 = theMenu.addChild(L03, "Document", "服务创建", "~cust/service/add.jsp", "服务创建...");
	L0302 = theMenu.addChild(L03, "Document", "服务分配", "~cust/service/findcsli.html?status=1", "服务分配...");
	L0303 = theMenu.addChild(L03, "Document", "服务处理", "~cust/service/findcsli.html?status=2", "服务处理...");
	L0304 = theMenu.addChild(L03, "Document", "服务反馈", "~cust/service/findcsli.html?status=3", "服务反馈...");
	L0305 = theMenu.addChild(L03, "Document", "服务归档", "~cust/service/findcsli.html?status=4", "服务归档...");
	
	
	L04 = theMenu.addChild(l2ID, "Folder", "统计报表", "", "统计报表...");
	L0401 = theMenu.addChild(L04, "Document", "客户贡献分析", "~rept/findyearcost.html", "客户贡献分析...");
	L0402 = theMenu.addChild(L04, "Document", "客户构成分析", "~rept/findgouchen.html", "客户构成分析...");
	L0403 = theMenu.addChild(L04, "Document", "客户服务分析", "~rept/findserresult.html", "客户服务分析...");
	L0404 = theMenu.addChild(L04, "Document", "客户流失分析", "~rept/fenxicl.html?lststatus=3", "客户流失分析...");
	
	L05 = theMenu.addChild(l2ID, "Folder", "基础数据", "", "基础数据...");
	L0501 = theMenu.addChild(L05, "Document", "数据字典管理", "~basd/findall.html", "数据字典管理...");
	L0502 = theMenu.addChild(L05, "Document", "查询产品信息", "~basd/findpro.html", "查询产品信息...");
	L0503 = theMenu.addChild(L05, "Document", "查询库存", "~basd/findsto.html", "查询库存...");
