...
<div class="button_bar">
	...
	<button class="common_button" onclick="to('findcstlostbyid.html?id=${cl.lstId}&type=1');">确认流失</button>
...
<table class="query_form_table">
	...
	<tr>
		<th>追加暂缓措施</th>
		<td colspan="3">
			<textarea rows="6" cols="50" id="msg"></textarea><span 
...
<script type="text/javascript">
	function updatesl(){
		var lstDelay="${cl.lstDelay }"+"</br>"+$("#msg").val();
		var lstId=$("#clid").html();
		var lstStatus=2;
		$.post("updatecl.html",{"lstId":lstId,"lstDelay":lstDelay,"lstStatus":lstStatus},function(res){
			if(res>0){
				alert("修改成功");
