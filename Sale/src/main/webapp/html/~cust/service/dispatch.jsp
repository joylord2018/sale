		...
		<td class="list_data_text">
			<select name="D2">
				...
				<c:forEach items="${salers }" var="saler">
					<option value="${saler.usrId }">${saler.usrName }</option>
				</c:forEach>
			</select>
			<button class="common_button" onclick="fenpei(${cs.svrId },this);">分配</button>  
...
function page(num){
 ...
 function fenpei(num,obj){
 	var dueid=$(obj).prev().val();
 	if(dueid!=""){
 		window.location.href="dueidadd.html?svrId="+num+"&svrDueId="+dueid+"&urltype=1";
 	}
 }
</script>
</html>
